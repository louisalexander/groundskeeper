...
It started as a single-file tool for one property — **a residential property, the area, VA** (the lot) — and is being rebuilt as a hosted, offline-capable, multi-device web app.
...
| | |
|--|--|
| Address | a residential property |
| Lot | 25, Block B — the subdivision |
| Survey | the surveyor · 2026-02-16 · (redacted) · NAD 83 |
